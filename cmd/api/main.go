...
func main() {
	...
	apiRouter.Group(func(r chi.Router) {
		...
		r.Post("/groups/images", groupsHandler.UploadGroupImage)
		...
		r.Get("/group-invites/{token}", groupsHandler.GetInvitePreview)
		...
		r.Post("/users/{id}/block", userHandler.BlockUser)
		r.Delete("/users/{id}/block", userHandler.UnblockUser)
		r.Post("/users/{id}/report", userHandler.ReportUser)
