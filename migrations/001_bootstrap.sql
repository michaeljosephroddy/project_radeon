...
ALTER TABLE meetups       ALTER COLUMN id SET DEFAULT gen_random_uuid();
...
ALTER TABLE meetup_attendees ALTER COLUMN rsvp_at  SET DEFAULT NOW();
ALTER TABLE chat_members  ALTER COLUMN joined_at   SET DEFAULT NOW();
